...
```
1. Load execution-plan.md — follow its 6 steps in order
...
4. Update ./docs/RUNBOOK.md last — after all other files are written
```
...
It contains the 6 ordered steps: extract feature name, identify changed files, read code, create doc, update indexes, update RUNBOOK.
