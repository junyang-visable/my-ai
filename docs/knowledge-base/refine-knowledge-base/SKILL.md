...
Do not read source code directly. The subagent in Step 3 reads code; the main agent writes KB files from its output.
...
It contains the 6 steps: confirm gap, identify scope, dispatch subagent, write KB files, sync RUNBOOK, update META.
